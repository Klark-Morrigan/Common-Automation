...
it as `uses: Klark-Morrigan/Common-Automation/.github/actions/actionlint@master`
...
the same `uses: Klark-Morrigan/Common-Automation/.github/actions/action-validator@master`
